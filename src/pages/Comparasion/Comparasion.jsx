          ...
          <div className="box_wrapper grid grid-cols-1  md:grid-cols-2  lg:grid-cols-3 gap-8 mt-[15px] place-items-center md:place-items-center  ">
            ...
            <div>
              <div className="flex flex-col items-center justify-center">
                ...
                <button className="rounded-[6px] mt-3 cursor-pointer w-[242px] h-[39px] bg-[#b88e2f] hover:bg-[#a47d28] active:bg-[#8c6a22] transition-colors duration-300  font-semibold text-[14px] leading-[1.265] text-[#fff] m  ">
                  Choose a Product
                </button>
              </div>
            </div>
